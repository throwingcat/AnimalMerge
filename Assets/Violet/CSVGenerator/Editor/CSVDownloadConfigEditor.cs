...
namespace Violet
{
    [CustomEditor(typeof(CSVDownloadConfig))]
    public class CSVDownloadConfigEditor : Editor
    {
        CSVDownloadConfig asset
        {
            get { return (CSVDownloadConfig) target; }
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (asset.ClassCreateFolder == null)
                asset.ClassCreateFolder = AssetDatabase.LoadAssetAtPath<Object>("Assets/Script/Data");
