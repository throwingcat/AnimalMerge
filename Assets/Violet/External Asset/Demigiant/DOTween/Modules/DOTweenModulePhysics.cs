...
namespace DG.Tweening
{
	public static class DOTweenModulePhysics
    {
        ...
        public static Tweener DORotate(this Rigidbody target, Vector3 endValue, float duration, RotateMode mode =
 RotateMode.Fast)
        {
 ...
 DOTween.To(() => target.rotation, target.MoveRotation, endValue, duration);
        ...
        public static Tweener DOLookAt(this Rigidbody target, Vector3 towards, float duration, AxisConstraint axisConstraint
